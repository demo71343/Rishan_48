...
var scoreTest1 = false;
var scoreTest2 = false;
var scoreTest3 = false;
var scoreTest4 = false;
var scoreTest5 = false;
var scoreTest6 = false;
var scoreTest = false;

var scoreTest7 = false;
var scoreTest8 = false;
var scoreTest9 = false;
var scoreTest10 = false;
var scoreTest11 = false;
var scoreTest12 = false;
...
function calculateScoreVirus(){
    console.log("Inside score");

    if (npc1.lifetime === 0 && scoreTest1 === false ){
        console.log("Inside npc1.lifetime");

        scoreTest1 = true;
        healthyPeople = healthyPeople-1;
        infectedPeople=infectedPeople+1;
    }

    if (npc2.lifetime === 0 && scoreTest2 === false ){
        scoreTest2 = true;
        console.log("Inside npc2.lifetime");
        healthyPeople = healthyPeople-1;
        infectedPeople=infectedPeople+1;
    }

    if (npc3.lifetime === 0 && scoreTest3 === false ){
        scoreTest3 = true;
        healthyPeople = healthyPeople-1;
        infectedPeople=infectedPeople+1;
    }

    if (npc4.lifetime === 0 && scoreTest4 === false ){
        scoreTest4 = true;
        healthyPeople = healthyPeople-1;
        infectedPeople=infectedPeople+1;
    }

    if (npc5.lifetime === 0 && scoreTest5 === false ){
        scoreTest5 = true;
        healthyPeople = healthyPeople-1;
        infectedPeople=infectedPeople+1;
    }

    if (npc6.lifetime === 0 && scoreTest6 === false ){
        scoreTest6 = true;
        healthyPeople = healthyPeople-1;
        infectedPeople=infectedPeople+1;
    }
...
function calculateScoreDoctor(){
    console.log("Inside score");

    if ( scoreTest1 === true && scoreTest7 === false && doctor.isTouching(npc1)){
        console.log("Trace 1");
    ...
    if (scoreTest2 === true && scoreTest8 === false && doctor.isTouching(npc2) ){
        scoreTest8 = true;
        console.log("Inside npc2.lifetime");
        healthyPeople = healthyPeople+1;
        infectedPeople=infectedPeople-1;
    ...
    if (scoreTest3 === true && scoreTest9 === false && doctor.isTouching(npc3) ){
        scoreTest9 = true;
        healthyPeople = healthyPeople+1;
        infectedPeople=infectedPeople-1;
    }

    if (scoreTest4 === true && scoreTest10 === false && doctor.isTouching(npc4)){
        scoreTest10 = true;
        healthyPeople = healthyPeople+1;
        infectedPeople=infectedPeople-1;
    }

    if (scoreTest5 === true && scoreTest11 === false && doctor.isTouching(npc5)){
        scoreTest11 = true;
        healthyPeople = healthyPeople+1;
        infectedPeople=infectedPeople-1;
    }

    if (scoreTest6 === true && scoreTest12 === false && doctor.isTouching(npc6)){
        scoreTest12 = true;
        healthyPeople = healthyPeople+1;
        infectedPeople=infectedPeople-1;
    }
